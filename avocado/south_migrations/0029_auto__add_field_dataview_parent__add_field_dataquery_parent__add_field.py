...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('avocado_dataview', 'parent',
        ...
        db.add_column('avocado_dataquery', 'parent',
        ...
        db.add_column('avocado_datacontext', 'parent',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('avocado_dataview', 'parent_id')

        # Deleting field 'DataQuery.parent'
        db.delete_column('avocado_dataquery', 'parent_id')

        # Deleting field 'DataContext.parent'
        db.delete_column('avocado_datacontext', 'parent_id')
