...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('avocado_datafield', 'label_field_name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)

        # Adding field 'DataField.search_field_name'
        db.add_column('avocado_datafield', 'search_field_name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)

        # Adding field 'DataField.order_field_name'
        db.add_column('avocado_datafield', 'order_field_name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)

        # Adding field 'DataField.code_field_name'
        db.add_column('avocado_datafield', 'code_field_name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('avocado_datafield', 'label_field_name')

        # Deleting field 'DataField.search_field_name'
        db.delete_column('avocado_datafield', 'search_field_name')

        # Deleting field 'DataField.order_field_name'
        db.delete_column('avocado_datafield', 'order_field_name')

        # Deleting field 'DataField.code_field_name'
        db.delete_column('avocado_datafield', 'code_field_name')
