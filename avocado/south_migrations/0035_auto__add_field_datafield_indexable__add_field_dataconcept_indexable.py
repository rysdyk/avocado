...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('avocado_datafield', 'indexable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'DataConcept.indexable'
        db.add_column('avocado_dataconcept', 'indexable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('avocado_datafield', 'indexable')

        # Deleting field 'DataConcept.indexable'
        db.delete_column('avocado_dataconcept', 'indexable')
