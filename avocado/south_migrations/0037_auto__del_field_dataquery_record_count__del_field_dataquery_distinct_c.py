...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('avocado_dataquery', 'tree')

        # Deleting field 'DataContext.count'
        db.delete_column('avocado_datacontext', '_count')

        # Deleting field 'DataContext.tree'
        db.delete_column('avocado_datacontext', 'tree')
