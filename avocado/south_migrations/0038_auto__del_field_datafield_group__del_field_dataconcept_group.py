...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('avocado_datafield', 'group_id')

        # Deleting field 'DataConcept.group'
        db.delete_column('avocado_dataconcept', 'group_id')


    def backwards(self, orm):
        # Adding field 'DataField.group'
        db.add_column('avocado_datafield', 'group',
        ...
        db.add_column('avocado_dataconcept', 'group',
